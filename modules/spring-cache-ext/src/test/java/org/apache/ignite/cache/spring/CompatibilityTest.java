...
public class CompatibilityTest extends IgniteCompatibilityAbstractTest {
    /**  */
    private static final String[] TESTED_IGNITE_VERSIONS = new String[] {
        IgniteVersionUtils.VER_STR
    };

    /**  */
    private static final String[] TESTED_SPRING_VERSIONS = new String[] {
        "4.3.0.RELEASE",
        "5.0.0.RELEASE",
        "5.1.0.RELEASE",
        "5.2.0.RELEASE",
    ...
    public static Iterable<Object[]> versions() {
        ...
        for (String igniteVer : TESTED_IGNITE_VERSIONS) {
            for (String springVer : TESTED_SPRING_VERSIONS)
                res.add(new Object[]{igniteVer, springVer});
        }
