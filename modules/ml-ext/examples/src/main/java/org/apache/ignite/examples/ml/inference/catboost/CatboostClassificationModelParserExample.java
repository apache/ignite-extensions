...
public class CatboostClassificationModelParserExample {
     ...
     */
    private static final String TEST_MODEL_RES = "models/catboost/model_clf.cbm";

    /**
     * Test data.
     */
    private static final String TEST_DATA_RES = "datasets/amazon-employee-access-challenge-sample.csv";

    /**
     * Test expected results.
     */
    private static final String TEST_ER_RES =
        "datasets/amazon-employee-access-challenge-sample-catboost-expected-results.csv";
