...
public class IgniteClientConfigSpringApplicationConfiguration {
    /**
     * Creating Apache Ignite thin client configuration bean which will be used to automatically instantiate the
     * Ignite thin client to access the Ignite cluster.
     */
    @Bean
