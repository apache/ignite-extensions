 ...
 *
 * DynamicQueryConfig withDynamicQuery = new DynamicQueryConfig().value("SELECT * from #{#entityName} where country = ?#{[0] and
 *     city = ?#{[1]}").setForceFieldsQuery(true).setLazy(true).setCollocated(true);
