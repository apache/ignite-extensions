...
import org.apache.ignite.springdata20.compoundkey.City;
import org.apache.ignite.springdata20.compoundkey.CityKey;
import org.apache.ignite.springdata20.compoundkey.CityRepository;
import org.apache.ignite.springdata20.compoundkey.CompoundKeyApplicationConfiguration;
...
public class IgniteSpringDataCompoundKeyTest extends GridCommonAbstractTest {
    ...
    public void loadData() throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:ignite:thin://127.0.0.1/")) {
            ...
            st.execute("CREATE TABLE City (ID INT, Name VARCHAR, CountryCode CHAR(3), District VARCHAR, Population INT, PRIMARY KEY (ID, CountryCode)) WITH \"template=partitioned, backups=1, affinityKey=CountryCode, CACHE_NAME=City, KEY_TYPE=org.apache.ignite.springdata20.compoundkey.CityKey, VALUE_TYPE=org.apache.ignite.springdata20.compoundkey.City\"");
