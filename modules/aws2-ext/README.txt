Apache Ignite AWS2 Module
------------------------

Apache Ignite AWS2 module provides S3-based implementations of checkpoint SPI and IP finder for TCP discovery.
This module is based on the AWS SDK 2.x.
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <dependencies>
        ...
        <dependency>
            ...
            <artifactId>ignite-aws2-ext</artifactId>
            <version>${ignite-aws2-ext.version}</version>
        </dependency>
        ...
    </dependencies>
    ...
