...
import com.sbt.ignite.plugin.segmentation.PluggableSegmentationResolver;
    ...
    @Override public void start() throws IgniteException {
        ...
        if (segResolvers.length > 1) {
            throw new IgniteException("Multiple Ignite plugins that provide " +
                PluggableSegmentationResolver.class.getName() + " extension are defined. Check your plugin" +
                " configurations and make sure that only one of them provides Segmentation Resolver. Cache will be" +
