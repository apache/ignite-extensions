...
public class IgniteRepositoryQuery implements RepositoryQuery {
    ...
    private Query prepareQuery(IgniteQuery qry, DynamicQueryConfig config, ReturnStrategy returnStgy, Object[] values) {
        ...
        if (!qry.isTextQuery()) {
            boolean isParamDependentClausesProcessingRequired;
            ...
            if (!qry.isAutogenerated()) {
                ...
                isParamDependentClausesProcessingRequired = isParameterDependentClausesProcessingRequired(squery);
            }
            else {
                ...
                isParamDependentClausesProcessingRequired = qry.isParameterDependent();
            }
            ...
            if (isParamDependentClausesProcessingRequired) {
    ...
    private boolean isParameterDependentClausesProcessingRequired(StringQuery qry) {
