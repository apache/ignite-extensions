...
Once added, Ignite instance will connect to Spring on start-up automatically. You can use Spring Session annotations in your code. For example, here is how you can create a simple controller:
